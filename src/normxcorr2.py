...
def normxcorr2(template, image, mode="full"):
    ...
    :param template: N-D array, of template or filter you are using for 
    cross-correlation.
    ...
    the zero-padding.
    same: The output is the same size as image, centered with respect to the
    ‘full’ output.
    :return: N-D array of same dimensions as image. Size depends on mode
    parameter.
    """
    ...
    # Faster to flip up down and left right then use fftconvolve instead of
    #scipy's correlate
